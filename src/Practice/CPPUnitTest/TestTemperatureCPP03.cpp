...
class TestTemperatureCPP03 : public CppUnit::TestCase
{
public:
	TestTemperatureCPP03(const string& name) : CppUnit::TestCase(name) {}
	...
	static CppUnit::Test* CreateTest()
	{
		...
		CppUnit_addTest(pSuite, TestTemperatureCPP03, test);

		return pSuite;
	}
};

AddTestCase<TestTemperatureCPP03> s_Test;